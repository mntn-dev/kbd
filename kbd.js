/*$.kbd-0.1;(c)2018 - Mntn(r) <https://mn.tn/> c/o Benjamin Lips <g--[AT]--mn.tn>;MIT-Licensed <https://mit-license.org/>;For documentation, see <https://github.com/mntn-dev/kbd/>*/
;(function($){
...
Q=function(_){q=$('#__q').text();return((_===0)?q.toLowerCase():q);};
...
$('._caps')
.mousedown(function(){
 if((q=Q()).toLowerCase()!='q')return;_kbd_t=setTimeout(function(_){_.addClass('_ext-caps');_.trigger('mouseup');_kbd_t='%';},1e3,$(this));
 })
.mouseup(function(){
 if((q=Q()).toLowerCase()!='q'||_kbd_t=='%')return((_kbd_t=!1));
 tc($(this));if(q=='Q'&&$(this).hasClass('_ext-caps'))$(this).removeClass('_ext-caps');if(_kbd_t)clearTimeout(_kbd_t);
...
$('._alt').click(function(){
 tc($(this));if(Q()=='Q'){tc($('._caps'));$('._caps').removeClass('_ext-caps');}
...
$('button[data-a],button[data-k],._ext-box button').mouseup(function(_$,r){
 ...
 if(Q()=='Q'&&!$('._caps').hasClass('_ext-caps'))$('._caps').trigger('mouseup');
});

$('button[data-k]').mousedown(function(){_kbd_t=setTimeout(function(_){_kbd_t=setInterval(function(){_.trigger('mouseup',!!1);},50,_);},2e2,$(this));});

$('._ext')
.mousedown(function(){if($(this).hasClass('_ext-1')||($(this).hasClass('_ext-0')&&Q(0)=='q'))_kbd_t=setTimeout(function(_){_.find('._ext-box').show();},750,$(this));})
.on('mouseup mouseleave',function(){$(this).find('._ext-box:visible').hide();if(_kbd_t)clearTimeout(_kbd_t);});
...
$.kbd.hide =function(){$('#_kbd').stop().animate({bottom:'-100%'},250);},
$.kbd.show =function(){$('#_kbd').stop().animate({bottom:0},250);},
